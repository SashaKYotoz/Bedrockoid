...
public class BlockUtils {
    ...
    public static boolean areAllNeighborsMatching(World world, BlockPos pos, Predicate<BlockState> predicate) {
        List<BlockState> blockStates = new ArrayList<>();
        for (Direction dir : Direction.values())
            blockStates.add(world.getBlockState(pos.offset(dir)));
        return blockStates.stream().allMatch(predicate);
    }
